!(function (e, t) {
    ...
    return (function (e) {
      ...
      1: function (e, t, i) {
        ...
        (r.register = (e, t) => (r[e] = (e) => new t(e))), (r.version = "0.5.6");
        const h = function () {
          return (
        ...
        class r extends o.b {
          ...
          onInit() {
            ...
            new n(function (t) {
              ...
              function y(e, i) {
                return (
                  (e = t.constrain(e, 0, t.width + 2 * r)),
                  (i = t.constrain(i, 0, t.height + 2 * r)),
                  d[t.floor(i / h)][t.floor(e / h)]
                );
              }
              function g(e, t) {
                return ((e % t) + t) % t;
                  ...
                  t.translate(-r, -r),
                    (function () {
                      for (let e = 0; e < p; e++) {
                        ...
                        (i.prev.x = i.pos.x),
                          (i.prev.y = i.pos.y),
                          (i.pos.x = g(i.pos.x + i.vel.x, t.width + 2 * r)),
                          (i.pos.y = g(i.pos.y + i.vel.y, t.height + 2 * r)),
                          i.vel.add(i.acc).normalize().mult(2.2),
                          (i.acc = t.createVector(0, 0)),
                          i.acc.add(o).mult(3);
                      }
                    })(),
                    (function () {
                      t.strokeWeight(1),
                        t.stroke(Object(s.b)(e.options.color, 0.05));
                      for (let e = 0; e < f.length; e++)
                        n.Vector.dist(f[e].prev, f[e].pos) < 10 &&
                          t.line(
                            f[e].prev.x,
                            f[e].prev.y,
                            f[e].pos.x,
